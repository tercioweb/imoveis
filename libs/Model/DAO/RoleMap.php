...
class RoleMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		...
		{
			self::$FM = Array();
			self::$FM["Id"] = new FieldMap("Id","role","r_id",true,FM_TYPE_INT,11,null,true);
	...
	public static function GetKeyMaps()
	{
		...
		{
			self::$KM = Array();
			self::$KM["fk_user_role"] = new KeyMap("fk_user_role", "Id", "User", "RoleId", KM_TYPE_ONETOMANY, KM_LOAD_LAZY);  // use KM_LOAD_EAGER with caution here (one-to-one relationships only)
		}
		return self::$KM;
	}

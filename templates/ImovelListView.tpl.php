...
-->
		...
		<form id="deleteImovelButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deleteImovelButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete Imovel</button>
						<span id="confirmDeleteImovelContainer" class="hide">
							<button id="cancelDeleteImovelButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteImovelButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="imovelDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit Imovel
		...
		<div class="modal-footer">
			...
			<button id="saveImovelButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newImovelButton" class="btn btn-primary">Add Imovel</button>
	</p>

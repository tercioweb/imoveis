...
<h1>
		...
		<form id="deleteTipoImovelButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deleteTipoImovelButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete TipoImovel</button>
						<span id="confirmDeleteTipoImovelContainer" class="hide">
							<button id="cancelDeleteTipoImovelButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteTipoImovelButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="tipoImovelDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit TipoImovel
		...
		<div class="modal-footer">
			...
			<button id="saveTipoImovelButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newTipoImovelButton" class="btn btn-primary">Add TipoImovel</button>
	</p>
